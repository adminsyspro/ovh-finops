...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    serviceDetails: 'Détail du service',
    serviceDetailsError: 'Impossible de charger le détail de ce service',
    serviceDetailsSearch: 'Rechercher une ligne',
    resourceTypeDetails: 'Détail du type de ressource',
    resourceTypeDetailsError: 'Impossible de charger le détail de ce type de ressource',
  ...
  en: {
    ...
    serviceDetailsError: 'Unable to load this service detail',
    serviceDetailsSearch: 'Search billing lines',
    resourceTypeDetails: 'Resource type details',
    resourceTypeDetailsError: 'Unable to load this resource type detail',
